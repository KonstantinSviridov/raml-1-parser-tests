...
describe('To Runtime Tests',function(){
    ...
    it ("Basic inheritance",function(){
        var rsm=parser.loadApiSync(path.resolve(dir,"data/typeSystem.raml"));
        var mt=_.find((<RamlWrapper.Api>util.expandWrapperIfNeeded(rsm)).types(),x=>x.name()=="AnotherType");
    ...
    it ("Inheritance 1",function(){
        var rsm=parser.loadApiSync(path.resolve(dir,"data/typeSystem.raml"));
        var mt=_.find((<RamlWrapper.Api>util.expandWrapperIfNeeded(rsm)).types(),x=>x.name()=="AnotherType2");
    ...
    it ("Array type",function(){
        var rsm=parser.loadApiSync(path.resolve(dir,"data/typeSystem.raml"));
        var mt=_.find((<RamlWrapper.Api>util.expandWrapperIfNeeded(rsm)).types(),x=>x.name()=="Arr");
    ...
    it ("Union Type",function(){
        var rsm=parser.loadApiSync(path.resolve(dir,"data/typeSystem.raml"));
        var mt=_.find((<RamlWrapper.Api>util.expandWrapperIfNeeded(rsm)).types(),x=>x.name()=="Un");
    ...
    //    var rsm=parser.loadApiSync(path.resolve(dir,"data/typeSystem.raml"));
    //    var mt=_.find((<RamlWrapper.Api>util.expandWrapperIfNeeded(rsm)).types(),x=>x.name()=="Facet");
    ...
    it ("Multiple inheritance",function(){
        var rsm=parser.loadApiSync(path.resolve(dir,"data/typeSystem.raml"));
        var mt=_.find((<RamlWrapper.Api>util.expandWrapperIfNeeded(rsm)).types(),x=>x.name()=="T4");
    ...
    it ("Inheritance loop",function(){
        var rsm=parser.loadApiSync(path.resolve(dir,"data/typeSystem.raml"));
        var mt=_.find((<RamlWrapper.Api>util.expandWrapperIfNeeded(rsm)).types(),x=>x.name()=="T6");
    ...
    it('Node by runtime type', function () {
        var api = parser.loadApiSync(path.resolve(dir,"data/typeSystem.raml"));
...
describe('Nominal Hierarchy Genuine User Defined Tests',function(){
    ...
    it ("Genuine User Defined 1",function(){
        var rsm=parser.loadApiSync(path.resolve(dir,"data/typesystem/genuine.raml"));
        var type=_.find((<RamlWrapper.Api>util.expandWrapperIfNeeded(rsm)).types(),x=>x.name()=="TestType1");
    ...
    it ("Genuine User Defined 2",function(){
        var rsm=parser.loadApiSync(path.resolve(dir,"data/typesystem/genuine.raml"));
        var type=_.find((<RamlWrapper.Api>util.expandWrapperIfNeeded(rsm)).types(),x=>x.name()=="TestType2");
    ...
    it ("Genuine User Defined 3",function(){
        var rsm=parser.loadApiSync(path.resolve(dir,"data/typesystem/genuine.raml"));
        var type=_.find((<RamlWrapper.Api>util.expandWrapperIfNeeded(rsm)).types(),x=>x.name()=="TestType3");
    ...
    it ("Genuine User Defined 4",function(){
        var rsm=parser.loadApiSync(path.resolve(dir,"data/typesystem/genuine.raml"));
        var type=_.find((<RamlWrapper.Api>util.expandWrapperIfNeeded(rsm)).types(),x=>x.name()=="TestType4");
    ...
    it ("Genuine User Defined 5",function(){
        var rsm=parser.loadApiSync(path.resolve(dir,"data/typesystem/genuine.raml"));
        var type=_.find((<RamlWrapper.Api>util.expandWrapperIfNeeded(rsm)).types(),x=>x.name()=="TestType5");
    ...
    it ("Genuine User Defined 6",function(){
        var rsm=parser.loadApiSync(path.resolve(dir,"data/typesystem/genuine.raml"));
        var type=_.find((<RamlWrapper.Api>util.expandWrapperIfNeeded(rsm)).types(),x=>x.name()=="TestType6");
    ...
    it ("Genuine User Defined 7",function(){
        var rsm=parser.loadApiSync(path.resolve(dir,"data/typesystem/genuine.raml"));
        var type=_.find((<RamlWrapper.Api>util.expandWrapperIfNeeded(rsm)).types(),x=>x.name()=="TestType7");
    ...
    it ("Genuine User Defined Method Response 1",function(){
        var api=parser.loadApiSync(path.resolve(dir,"data/typesystem/genuine.raml"));
    ...
    it ("Built-in facets for Object type",function(){
        var api=parser.loadApiSync(path.resolve(dir,"data/typesystem/facets.raml"));
...
function testFacets(typeNode:hl.BasicNode,expected:any,ignoredProperties:any={},all=false){
