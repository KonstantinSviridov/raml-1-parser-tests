...
import parserMod = parser.parser.modify;
import project = parser.project;
import search = parser.search;
import schema = parser.schema;
...
describe('Parser index functions tests',function() {
    ...
    it("loadRaml", function(done){
        ...
        parser.loadRAML(util.data("../example-ramls/Instagram/api.raml"), []).then((api: any) => {
            try {
    ...
    it("getLanguageElementByRuntimeType", function(){
        ...
        var type: any = parser.getLanguageElementByRuntimeType((<any>api).wrapperNode().types()[0].runtimeType());
    ...
    it("isFragment", function(){
        ...
        assert.equal((<any>parser).isFragment(api.wrapperNode()), true);
    });

    it("asFragment", function(){
        var api = util.loadApi(util.data('./functions/simple1.raml'));

        var asFragment = (<any>parser).asFragment(api.wrapperNode());
...
describe('Parser project functions tests',function() {
    ...
    it("createProject", function () {
        ...
        var api = parser.parseRAMLSync(content);
...
describe('Parser searchProxy functions tests',function() {
    ...
    it("globalDeclarations", function (done) {
        ...
        parser.loadRAML(util.data('./functions/simple.raml'), []).then((wrapper: any) => {
    ...
    it("nodesDeclaringType", function (done) {
        ...
        parser.loadRAML(util.data('./functions/api.raml'), []).then((wrapper: any) => {
    ...
    it("referenceTargets", function (done) {
        ...
        parser.loadRAML(util.data('./functions/api1.raml'), []).then((wrapper: any) => {
            var highLevelNode = wrapper.types()[0].highLevel();
...
describe('Parser parser/artifacts factories functions tests',function() {
    ...
    it("wrappers test 5", function (done) {
        ...
        parser.loadRAML(util.data('./functions/simple10_1.raml'), []).then((wrapper: any) => {
            try {
    ...
    it("wrappers test 6", function (done) {
        ...
        parser.loadRAML(util.data('./functions/RAML08/Instagram/api.raml'), []).then((wrapper: any) => {
            try {
...
describe('Unit kind tests',function() {
    ...
    it("Main RAML unit detection", function (done) {
        parser.loadRAML(util.data('./functions/unitKindTests/apiraml'), []).then((wrapper: any) => {
            try {
