...
describe('Helper methods', function () {
    ...
    it('Api.allTraits()', function () {
        api = <RamlWrapper.Api>parser.loadApiSync("./helperTestApi.raml");
    ...
    it('Api boolean type()', function () {
        var found=false;
        var apiObj = <RamlWrapper.Api>parser.loadApiSync("./testBoolType.raml");
    ...
    it('Api validate instance of union type failing 2', function () {
        var found=false;
        var apiObj = <RamlWrapper.Api>parser.loadApiSync("./testUnionType.raml");
    ...
    it('Api testing component type', function () {
        var found=false;
        var apiObj = <RamlWrapper.Api>parser.loadApiSync("./testComponentType.raml");
    ...
    //    var api = parser.loadApiSync("./helper/securedBy_10.raml");
    //    var resource = tools.collectionItem(api.resources(),0);
    //
    //    var defaultSchemasNumber = tools.getLength((<RamlWrapper.ResourceImpl>resource).securedBy());
    //    assert.equal(defaultSchemasNumber,0);
    ...
    //    var api = parser.loadApiSync("./helper/securedBy3_10.raml");
    //    var resource = tools.collectionItem(api.resources(),0);
    //    var method = tools.collectionItem(resource.methods(),0);
    //
    //    var defaultSchemasNumber = tools.getLength((<RamlWrapper.MethodImpl>method).securedBy());
    ...
    //    var api = parser.loadApiSync("./helper/securedBy2_10.raml");
    //    var resource = tools.collectionItem(api.resources(),0);
    //
    //    var defaultSchemasNumber = tools.getLength((<RamlWrapper.ResourceImpl>resource).securedBy());
    //    assert.equal(defaultSchemasNumber,1);
    ...
    it('Api.version() 0.8', function () {
        var api = parser.loadApiSync("./helper/securedBy.raml");

        assert.equal(api.RAMLVersion(), "RAML08");
    });

    it('Defaults for UriParameter#displayName', function () {
        var api = parser.loadApiSync(util.data("parser/defaults/uriParameters.raml"),
    ...
    it('Defaults for UriParameter#displayName', function () {
        var api = parser.loadApiSync(util.data("parser/defaults/uriParameters_08.raml"),
            {attributeDefaults:true});
    ...
    it('Defaults for UriParameter#displayName , allUriParameters', function () {
        var api = parser.loadApiSync(util.data("parser/defaults/uriParameters2.raml"),
            {attributeDefaults:true});
    ...
    it('Defaults for UriParameter#displayName , allUriParameters', function () {
        var api = parser.loadApiSync(util.data("parser/defaults/uriParameters2_08.raml"),
            {attributeDefaults:true});
    ...
    it('Defaults for QueryParameter#displayName', function () {
        var api = parser.loadApiSync(util.data("parser/defaults/queryParameters.raml"),
            {attributeDefaults:true});
    ...
    it('Defaults for QueryParameter#displayName', function () {
        var api = parser.loadApiSync(util.data("parser/defaults/queryParameters_08.raml"),
            {attributeDefaults:true});
    ...
    it('Defaults for Header#displayName', function () {
        var api = parser.loadApiSync(util.data("parser/defaults/headers.raml"),
            {attributeDefaults:true});
    ...
    it('Defaults for Header#displayName', function () {
        var api = parser.loadApiSync(util.data("parser/defaults/headers_08.raml"),
            {attributeDefaults:true});
    ...
    //     var api = parser.loadApiSync(util.data("helper/schema1_10.raml"),
    //         {attributeDefaults:true});
    //
    //     var resource = tools.collectionItem(api.resources(), 0);
    //     var method = tools.collectionItem(resource.methods(), 0);
    ...
    //     var api = parser.loadApiSync(util.data("helper/schema2_10.raml"),
    //         {attributeDefaults:true});
    //
    //     var resource = tools.collectionItem(api.resources(), 0);
    //     var method = tools.collectionItem(resource.methods(), 0);
    ...
    //     var api = parser.loadApiSync(util.data("helper/schema3_10.raml"),
    //         {attributeDefaults:true});
    //
    //     var resource = tools.collectionItem(api.resources(), 0);
    //     var method = tools.collectionItem(resource.methods(), 0);
    ...
    it('TypeDeclaration.schemaContent 1 #0.8', function () {
        var api = parser.loadApiSync(util.data("helper/schema1_08.raml"),
            {attributeDefaults:true});
    ...
    it('TypeDeclaration.schemaContent 2 #0.8', function () {
        var api = parser.loadApiSync(util.data("helper/schema2_08.raml"),
            {attributeDefaults:true});
    ...
    it('TypeDeclaration.schemaContent 3 #0.8', function () {
        var api = parser.loadApiSync(util.data("helper/schema3_08.raml"),
            {attributeDefaults:true});
    ...
    it('Scalar properties annotations 1', function () {
        var api = parser.loadApiSync(util.data("parser/annotations/a29.raml"),
            {attributeDefaults:true});
    ...
    it('Scalar properties annotations 2', function () {
        var api:any = parser.loadApiSync(util.data("parser/annotations/a30.raml"),
            {attributeDefaults:true});
    ...
    it('Multiple media types 1', function () {
        var api = parser.loadApiSync(util.data("parser/media/m5.raml"),
            {attributeDefaults: true});
    ...
    it('parse raml from content', function () {
        var title=(<any>parser.parseRAMLSync(["#%RAML 1.0",
            "title: My API with Types"
        ].join("\n"))).title();
        assert.equal(title,"My API with Types")
    });
    it('parse raml from content', function () {
        var type=(<any>parser.parseRAMLSync(["#%RAML 1.0",
            "title: My API with Types",
            "types: ",
            "  X: string |number"
        ].join("\n"))).types()[0];
    ...
    it('TypeError. reading uriParameters.', function () {
        var api = <RamlWrapper.Api>parser.loadApiSync("./helper/APIs/api001.raml");
        var exception;
        try {
    ...
    it('Items() for array expression 1', function () {
        var api=(<any>parser.parseRAMLSync(["#%RAML 1.0",
            "title: My API with Types",
            "types: ",
            "  Component:",
            "  TestType: Component[]"
