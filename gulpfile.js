...
var testFilesLibExpand = [
  'dist/parser/schema-model-tests.js',
  // ////
  'dist/parser/parserTests.js',
  'dist/parser/parserTests2.js',
  'dist/parser/parserASTTests.js',
  'dist/parser/traits-and-resource-types-expanding-tests.js',
  'dist/parser/helpersTest.js',
  'dist/search/test/gotoDeclarationTests.js',
  'dist/search/test/findUsagesTests.js',
  'dist/parser/exampleGenTests.js',
  'dist/parser/typeSystemTests.js',
  'dist/parser/runtimeExampleTests.js',
  'dist/parser/examplesApiTests.js',
  'dist/parser/virtualFSTests.js',
  'dist/parser/TCK.js',
  'dist/parser/TCK2.js',
  'dist/parser/libraryExpansion.js',
  'dist/parser/TCK2-newFormat.js',
  'dist/parser/libraryExpansion-newFormat.js',
  'dist/parser/astReuseTests.js',
  'dist/parser/astReuseTestsBasicTyping.js',
  'dist/parser/astReuseTestsComplexTyping.js',
  'dist/parser/longivityTestsBasicTyping.js',
  'dist/parser/longivityTestsComplexTyping.js',
  'dist/parser/longivityTestsUserTyping.js',
  'dist/parser/unfoldTypes.js',
    'dist/parser/unfoldTypesLibExpand.js',
  // // //
  'src/parser/data/parser/test/specs/optionals.js',
  'src/parser/data/parser/test/specs/parser.js',
  'src/parser/data/parser/test/specs/protocols.js',
  'src/parser/data/parser/test/specs/regressions.js',
  'src/parser/data/parser/test/specs/resourceTypes.js',
  'src/parser/data/parser/test/specs/resourceTypesValidations.js',
  'src/parser/data/parser/test/specs/traits.js',
  'src/parser/data/parser/test/specs/transformations.js',
  'src/parser/data/parser/test/specs/validator.js',
  'src/parser/data/parser/test/specs/duplicateKeysValidations.js',
  'dist/parser/parserTestsRC2.js'
]

var testFilesExpand = [
  'dist/parser/schema-model-tests.js',
  'dist/parser/funcTests.js',
].concat(testFilesLibExpand)

var testFilesAll = [
  'src/**/*.test.js',
  'test/**/*.js',
  //'dist/parser/model-editing-tests-attrs.js',
  'dist/parser/model-editing-tests-add.js',
  'dist/parser/model-editing-tests-refactoring.js',
  'dist/parser/model-editing-tests-remove.js',
  'dist/parser/model-editing-tests-sig.js',
...
gulp.task('testCompat', function () {
  //return gulp.src(['src/**/*.test.js', 'test/**/*.js', 'src/parser/model-editing-tests-attrs.js', 'src/parser/model-editing-tests-add.js', 'src/parser/*.js'], { read: false })
  return gulp.src([
